          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFF15181D), borderRadius: BorderRadius.circular(24), border: Border.all(color: Colors.white10)),
                child: Column(children: [
                  Text('SERIE ${setIndex + 1}', style: TextStyle(color: accent, fontWeight: FontWeight.w900, letterSpacing: 1.2)),
                  const SizedBox(height: 12),
                  Text('${current.reps}', style: const TextStyle(fontSize: 64, fontWeight: FontWeight.w900)),
                  const Text('repeticiones', style: TextStyle(color: Colors.white54)),
                ]),
              ),
              ...
              SizedBox(
                ...
                child: FilledButton.icon(
                  ...
                  icon: Icon(lastSet && lastExercise ? Icons.check_rounded : Icons.arrow_forward_rounded),
                  label: Text(lastSet && lastExercise ? 'TERMINAR' : 'SERIE COMPLETADA'),
                ),
              ),
            ],
          ),
        ...
        child: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Container(width: 82, height: 82, decoration: BoxDecoration(color: Theme.of(context).colorScheme.primary.withValues(alpha: .14), shape: BoxShape.circle), child: Icon(Icons.check_rounded, size: 48, color: Theme.of(context).colorScheme.primary)),
                const SizedBox(height: 24),
                const Text('¡Entrenamiento completado!', textAlign: TextAlign.center, style: TextStyle(fontSize: 30, fontWeight: FontWeight.w900)),
                const SizedBox(height: 10),
                Text('$exerciseCount ejercicios · $minutes min', style: const TextStyle(color: Colors.white60)),
                const SizedBox(height: 28),
                SizedBox(width: double.infinity, height: 54, child: FilledButton(onPressed: () => Navigator.of(context).pop(), child: const Text('VOLVER A INICIO'))),
              ],
            ),
          ),
        ),
